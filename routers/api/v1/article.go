...
func GetArtuicles(c *gin.Context) {
	appG := app.Gin{C: c}
	valid := validation.Validation{}
	...
	if err != nil {
		appG.Response(http.StatusServiceUnavailable, e.ERROR_COUNT_ARTICLE_FAIL, nil)
		return
	}
...
type AddArticleForm struct {
	...
	CreatedBy     string `form:"created_by" valid:"Required;MaxSize(155)"`
